...
HCC_LIGHTS.CurveAni.prototype={
    ...
    show:function(start_,end_){
        ...
        //var tubeGeo=new THREE.TubeGeometry(LineCurve,1,.8,10);
        //var tubeGeo=new THREE.TubeGeometry(LineCurve,1,1,10);
        //var tubeGeo=new THREE.TubeGeometry(LineCurve,1,.5,10);
        var tubeGeo=new THREE.TubeGeometry(LineCurve,1,.5,3);
